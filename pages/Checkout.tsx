                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4 p-4 rounded-xl bg-background-light dark:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-700">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-[#181111] dark:text-white font-bold leading-tight uppercase italic">2x Ingressos Rodízio</p>
                                        <p className="text-[#8a6060] dark:text-gray-400 text-xs font-medium">Sábado, 20:00h • Golden Diner</p>
                                        <p className="text-primary text-sm font-extrabold mt-1">R$ 60,00</p>
                                    </div>
                                </div>
                                <div className="pt-4 border-t border-gray-100 dark:border-gray-800 space-y-2">
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-500 dark:text-gray-400">Subtotal</span>
                                        <span className="font-bold text-[#181111] dark:text-white italic">R$ 60,00</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                    ...
                                    <div className="flex justify-between items-center pt-4 border-t border-primary/20">
                                        ...
                                        <span className="text-3xl font-black text-primary italic">R$ 60,00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
